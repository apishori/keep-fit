...
urlpatterns = [
    ...
    path('bytitle/', views.TitlePostListView.as_view(), name='get-post-title'), #getpost_by_title() for search
    ...
    path('all/', views.PostListView.as_view(), name='get-post'), #getpost() for news feed
]
